...
describe("getArcProgress", () => {
  ...
  test("hides both celestial markers for a future selected day", () => {
    const now = new Date("2026-07-04T12:00:00");

    expect(getArcProgress("06:00", "18:00", "2026-07-07", now)).toBeNull();
    expect(getArcProgress("18:42", "05:11", "2026-07-07", now)).toBeNull();
  });

  test("hides a today marker outside its same-day window", () => {
    expect(getArcProgress("06:00", "18:00", "2026-07-04", new Date("2026-07-04T05:59:00"))).toBeNull();
    expect(getArcProgress("06:00", "18:00", "2026-07-04", new Date("2026-07-04T18:01:00"))).toBeNull();
  });
