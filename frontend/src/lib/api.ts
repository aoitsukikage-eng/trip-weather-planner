...
export interface MoonInfo { target_date: string; moonrise_time: string | null; moonset_time: string | null; phase: string; icon: string; illumination_fraction: number; waxing: boolean; }
...
function mockForecast(town: Town, date: string): ForecastResult {
  ...
  return {
    forecast: {
      ...
      warnings: [],
      moon: { target_date: clampedDate, moonrise_time: "18:42", moonset_time: "05:11", phase: "眉月", icon: "🌒", illumination_fraction: 0.18, waxing: true },
